...
const Navbar = () => {
  ...
  const navItems = [
    { name: 'Dashboard', icon: FaHouseUser, href: '/registrarDashboard', hasSubmenu: false },
    { 
      name: 'Settings', 
      icon: FaCog, 
      href: '#', 
      hasSubmenu: true,
      submenuItems: [
        { name: 'Edit Profile', icon: FaUserEdit, href: '/registrarSettings' }
      ]
    },
    { name: 'Logout', icon: FaSignOutAlt, href: '/login', hasSubmenu: false }
  ];
